...
export const handler = async (event) => {
    ...
    try {        
        ...
        // generate id with uuid library and prepare payload
        const orderId = uuidv4();
        orderRequest.id = orderId;

        // publish message to sns topic with using sns sdk package
        let params = {
        ...
        // save order item into dynamodb with using dnamodb sdk package
        ...
        // return back snyc order payload with generated id to the api gateway
        return {
            statusCode: 200,
            body: JSON.stringify({
